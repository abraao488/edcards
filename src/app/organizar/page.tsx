...
import { OrganizarClient } from "./client"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-14 lg:pl-64 lg:pt-0">
        <div className="relative flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center p-4 sm:p-6 lg:p-8 lg:min-h-screen">
