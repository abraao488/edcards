...
import { CriarComRevisaiClient } from "./client"

export const dynamic = "force-dynamic"

export default async function CriarComRevisaiPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pl-64">
        <div className="relative p-8 h-screen flex flex-col">
